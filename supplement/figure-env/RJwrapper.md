...
bibliography:
- figure-example.bib
title: Working with figure environments
---
...
summarized in the table [1](#tab:graphics)
...
[]{#tab:graphics label="tab:graphics"}
:::

# Image without width parameters
...
Pandoc v3 and above now supports a new Figure object which supports
multiple images side by side or in a grid format.
...
<p>= [rectangle, rounded corners, minimum width=3cm, minimum height=1cm,
text centered, draw=black] = [thick,-&gt;,&gt;=stealth]</p>

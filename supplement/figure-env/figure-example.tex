...
\title{Working with figure environments}
...
\subsection{Multiple images}
 Pandoc v3 and above now supports a new Figure object which supports multiple 
...
Here is a tikz image example in fig \ref{fig:tikz} adapted from \citet{tikzflow}.
...
Here is an example of algorithm \ref{alg:how}, referenced from \citet{algoexample}
\begin{algorithm}[H]
\SetAlgoLined
\KwData{this text}

...
*Done, will be included in the latest CRAN release of the package.*
...
*Done, intermediate `.Rmd` and `.md` files would be included in the next iteration of article. They are generated via the `texor::latex_to_web()` function and, by default, are retained automatically after a successful conversion without requiring explicit arguments.*
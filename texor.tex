...
{\centering \includegraphics[width=1\linewidth]{texor_files/figure-latex/workflow-1} 

}

\caption{Workflow of the document conversion conducted by texor. (Note: AST is pandoc's abstract syntax tree.)}\label{fig:workflow}
\end{figure}

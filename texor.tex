...
\hypertarget{known-problems-needing-manual-fixes}{%
\section{Known problems needing manual fixes}\label{known-problems-needing-manual-fixes}}
...
\item
  \CRANpkg{rebib}: Version 0.3.0 \url{https://abhi-1u.github.io/rebib/}
\item

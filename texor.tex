...
\hypertarget{using}{%
\subsection{\texorpdfstring{Using \CRANpkg{rebib}}{Using }}\label{using}}
...
The \CRANpkg{texor} and \CRANpkg{rebib} source codem and materials to reproduce this paper are available at:

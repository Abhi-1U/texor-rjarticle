...
The decision to convert to R Markdown format means that the output to pdf and HTML will depend on Pandoc [@pandoc]. 
...
**DC: Can you explain what a Lua filter is?**
...
**DC: Add a diagram here showing flow of work, just pre-process .tex -> pandoc -> lua ???**

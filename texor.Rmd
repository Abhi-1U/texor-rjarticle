...
# Rebib is in charge of the bibliography
...
the usage of rebib and its stability with various formats. However,
the package has improved over time and proven to be a good performer.

Rebib's best feature is its ability to merge bibliographies from both the 
LaTeX and BibTeX files. \CRANpkg{rebib} saves authors from manually 

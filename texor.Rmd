...
```{r workflow1, fig.cap="Workflow of the document conversion conducted by texor.", out.width="90%", fig.align='center', eval=knitr::is_latex_output()}
knitr::include_graphics("workflow.png")
```

```{r workflow, fig.cap="Workflow of the document conversion conducted by texor.", out.width="90%", fig.align='center', eval=knitr::is_html_output()}
#knitr::include_graphics("workflow.png")
library(DiagrammeR)
